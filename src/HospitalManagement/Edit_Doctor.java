...
public class Edit_Doctor extends JFrame implements ActionListener
{
    ...
    Edit_Doctor(String username)
    {
        ...
        ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("HospitalManagement/Icons/Add Doctor.jpg"));
        Image i1=img.getImage().getScaledInstance(900,600,Image.SCALE_SMOOTH);
        ImageIcon img1=new ImageIcon(i1);
        l1.setIcon(img1);
        
        l2=new JLabel(" Edit Doctor Detials ");
        ...
        try
        {
            ...
            while(rest.next())
            {
                ...
                t14.setText(rest.getString("specalization"));
                l1.add(t14);
            }    
        }
        catch(Exception ee)
        ...
        f.setLocation(300,100); 
            ...
            {
                JOptionPane.showMessageDialog(null,"Rcord not found, Pleste filll the right Doctpr username !");
    ...
    public  void actionPerformed(ActionEvent e)
    {
      if(e.getSource()==bt1)
      {
        ...
        {
           ConnectionClass obj = new ConnectionClass();
           String q2= "update doctor set name='"+name+"',dob='"+dob+"',address='"+address+"',phone='"+phone+"',email='"+email+"',city='"+city+"',gender='"+gender+"',blood='"+blood+"',age='"+age+"',clinic_no='"+clinic+"',joining='"+jod+"',spcialization='"+splz+"'where username='"+username+"'";
