...
{   
    ...
    View_Doctor()
    {
        ...
        bt1=new JButton(" Edit Delete Record");
    ...
    public  void actionPerformed(ActionEvent ae)
    {
       ...
       if(ae.getSource()==bt)
       {
           try
           {
              ...
              String q2=" update appointement set appointement_status='Cancle'where doctor_username='"+username+"'and appointement_status='Open'";
